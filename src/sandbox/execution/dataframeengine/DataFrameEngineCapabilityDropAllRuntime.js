/**
 * DataFrameEngineCapabilityDropAllRuntime.js - Sandboxed Agent Tool Execution: DataFrameEngine -> CapabilityDropAll.
 */

class DataFrameEngineCapabilityDropAllRuntime {
...
module.exports = { DataFrameEngineCapabilityDropAllRuntime };
