/**
 * DataFrameEngineChrootIsolationJailRuntime.js - Sandboxed Agent Tool Execution: DataFrameEngine -> ChrootIsolationJail.
 */

class DataFrameEngineChrootIsolationJailRuntime {
...
module.exports = { DataFrameEngineChrootIsolationJailRuntime };
