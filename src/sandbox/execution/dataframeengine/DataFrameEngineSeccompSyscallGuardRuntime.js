/**
 * DataFrameEngineSeccompSyscallGuardRuntime.js - Sandboxed Agent Tool Execution: DataFrameEngine -> SeccompSyscallGuard.
 */

class DataFrameEngineSeccompSyscallGuardRuntime {
...
module.exports = { DataFrameEngineSeccompSyscallGuardRuntime };
