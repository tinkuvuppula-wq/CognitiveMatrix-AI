/**
 * DataFrameEngineProcessPidLimiterRuntime.js - Sandboxed Agent Tool Execution: DataFrameEngine -> ProcessPidLimiter.
 */

class DataFrameEngineProcessPidLimiterRuntime {
...
module.exports = { DataFrameEngineProcessPidLimiterRuntime };
