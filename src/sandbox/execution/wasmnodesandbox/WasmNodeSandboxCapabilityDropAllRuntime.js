/**
 * WasmNodeSandboxCapabilityDropAllRuntime.js - Sandboxed Agent Tool Execution: WasmNodeSandbox -> CapabilityDropAll.
 */

class WasmNodeSandboxCapabilityDropAllRuntime {
...
module.exports = { WasmNodeSandboxCapabilityDropAllRuntime };
