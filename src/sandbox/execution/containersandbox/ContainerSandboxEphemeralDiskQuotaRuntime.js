/**
 * ContainerSandboxEphemeralDiskQuotaRuntime.js - Sandboxed Agent Tool Execution: ContainerSandbox -> EphemeralDiskQuota.
 */

class ContainerSandboxEphemeralDiskQuotaRuntime {
...
module.exports = { ContainerSandboxEphemeralDiskQuotaRuntime };
