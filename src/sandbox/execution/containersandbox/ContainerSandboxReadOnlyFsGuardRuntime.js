/**
 * ContainerSandboxReadOnlyFsGuardRuntime.js - Sandboxed Agent Tool Execution: ContainerSandbox -> ReadOnlyFsGuard.
 */

class ContainerSandboxReadOnlyFsGuardRuntime {
...
module.exports = { ContainerSandboxReadOnlyFsGuardRuntime };
