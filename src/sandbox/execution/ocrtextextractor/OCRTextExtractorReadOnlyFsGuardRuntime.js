/**
 * OCRTextExtractorReadOnlyFsGuardRuntime.js - Sandboxed Agent Tool Execution: OCRTextExtractor -> ReadOnlyFsGuard.
 */

class OCRTextExtractorReadOnlyFsGuardRuntime {
...
module.exports = { OCRTextExtractorReadOnlyFsGuardRuntime };
