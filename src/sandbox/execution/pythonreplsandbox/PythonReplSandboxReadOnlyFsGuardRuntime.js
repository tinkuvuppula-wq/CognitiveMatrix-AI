/**
 * PythonReplSandboxReadOnlyFsGuardRuntime.js - Sandboxed Agent Tool Execution: PythonReplSandbox -> ReadOnlyFsGuard.
 */

class PythonReplSandboxReadOnlyFsGuardRuntime {
...
module.exports = { PythonReplSandboxReadOnlyFsGuardRuntime };
