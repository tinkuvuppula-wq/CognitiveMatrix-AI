/**
 * PythonReplSandboxCapabilityDropAllRuntime.js - Sandboxed Agent Tool Execution: PythonReplSandbox -> CapabilityDropAll.
 */

class PythonReplSandboxCapabilityDropAllRuntime {
...
module.exports = { PythonReplSandboxCapabilityDropAllRuntime };
