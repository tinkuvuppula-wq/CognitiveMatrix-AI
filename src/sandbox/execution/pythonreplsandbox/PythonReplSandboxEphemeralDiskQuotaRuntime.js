/**
 * PythonReplSandboxEphemeralDiskQuotaRuntime.js - Sandboxed Agent Tool Execution: PythonReplSandbox -> EphemeralDiskQuota.
 */

class PythonReplSandboxEphemeralDiskQuotaRuntime {
...
module.exports = { PythonReplSandboxEphemeralDiskQuotaRuntime };
