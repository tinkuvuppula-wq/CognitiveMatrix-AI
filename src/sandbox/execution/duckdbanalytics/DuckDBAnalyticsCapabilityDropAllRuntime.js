/**
 * DuckDBAnalyticsCapabilityDropAllRuntime.js - Sandboxed Agent Tool Execution: DuckDBAnalytics -> CapabilityDropAll.
 */

class DuckDBAnalyticsCapabilityDropAllRuntime {
...
module.exports = { DuckDBAnalyticsCapabilityDropAllRuntime };
