/**
 * DuckDBAnalyticsReadOnlyFsGuardRuntime.js - Sandboxed Agent Tool Execution: DuckDBAnalytics -> ReadOnlyFsGuard.
 */

class DuckDBAnalyticsReadOnlyFsGuardRuntime {
...
module.exports = { DuckDBAnalyticsReadOnlyFsGuardRuntime };
