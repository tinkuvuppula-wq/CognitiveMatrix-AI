/**
 * HeadlessBrowserSandboxSeccompSyscallGuardRuntime.js - Sandboxed Agent Tool Execution: HeadlessBrowserSandbox -> SeccompSyscallGuard.
 */

class HeadlessBrowserSandboxSeccompSyscallGuardRuntime {
  constructor(runtimeConfig = {}) {
    this.sandbox = 'HeadlessBrowserSandbox';
    this.securityGuardrail = 'SeccompSyscallGuard';
...
module.exports = { HeadlessBrowserSandboxSeccompSyscallGuardRuntime };
