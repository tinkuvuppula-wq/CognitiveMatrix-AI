/**
 * HeadlessBrowserSandboxEgressNetworkFirewallRuntime.js - Sandboxed Agent Tool Execution: HeadlessBrowserSandbox -> EgressNetworkFirewall.
 */

class HeadlessBrowserSandboxEgressNetworkFirewallRuntime {
  constructor(runtimeConfig = {}) {
    this.sandbox = 'HeadlessBrowserSandbox';
    this.securityGuardrail = 'EgressNetworkFirewall';
...
module.exports = { HeadlessBrowserSandboxEgressNetworkFirewallRuntime };
