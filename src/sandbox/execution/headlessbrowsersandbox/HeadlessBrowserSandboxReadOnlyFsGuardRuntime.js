/**
 * HeadlessBrowserSandboxReadOnlyFsGuardRuntime.js - Sandboxed Agent Tool Execution: HeadlessBrowserSandbox -> ReadOnlyFsGuard.
 */

class HeadlessBrowserSandboxReadOnlyFsGuardRuntime {
  constructor(runtimeConfig = {}) {
    this.sandbox = 'HeadlessBrowserSandbox';
    this.securityGuardrail = 'ReadOnlyFsGuard';
...
module.exports = { HeadlessBrowserSandboxReadOnlyFsGuardRuntime };
