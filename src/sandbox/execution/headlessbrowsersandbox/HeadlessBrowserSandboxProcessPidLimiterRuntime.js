/**
 * HeadlessBrowserSandboxProcessPidLimiterRuntime.js - Sandboxed Agent Tool Execution: HeadlessBrowserSandbox -> ProcessPidLimiter.
 */

class HeadlessBrowserSandboxProcessPidLimiterRuntime {
  constructor(runtimeConfig = {}) {
    this.sandbox = 'HeadlessBrowserSandbox';
    this.securityGuardrail = 'ProcessPidLimiter';
...
module.exports = { HeadlessBrowserSandboxProcessPidLimiterRuntime };
