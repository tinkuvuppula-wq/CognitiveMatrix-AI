/**
 * HeadlessBrowserSandboxCapabilityDropAllRuntime.js - Sandboxed Agent Tool Execution: HeadlessBrowserSandbox -> CapabilityDropAll.
 */

class HeadlessBrowserSandboxCapabilityDropAllRuntime {
  constructor(runtimeConfig = {}) {
    this.sandbox = 'HeadlessBrowserSandbox';
    this.securityGuardrail = 'CapabilityDropAll';
...
module.exports = { HeadlessBrowserSandboxCapabilityDropAllRuntime };
