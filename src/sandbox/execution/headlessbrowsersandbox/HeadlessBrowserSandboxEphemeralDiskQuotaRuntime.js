/**
 * HeadlessBrowserSandboxEphemeralDiskQuotaRuntime.js - Sandboxed Agent Tool Execution: HeadlessBrowserSandbox -> EphemeralDiskQuota.
 */

class HeadlessBrowserSandboxEphemeralDiskQuotaRuntime {
  constructor(runtimeConfig = {}) {
    this.sandbox = 'HeadlessBrowserSandbox';
    this.securityGuardrail = 'EphemeralDiskQuota';
...
module.exports = { HeadlessBrowserSandboxEphemeralDiskQuotaRuntime };
