/**
 * HeadlessBrowserSandboxChrootIsolationJailRuntime.js - Sandboxed Agent Tool Execution: HeadlessBrowserSandbox -> ChrootIsolationJail.
 */

class HeadlessBrowserSandboxChrootIsolationJailRuntime {
  constructor(runtimeConfig = {}) {
    this.sandbox = 'HeadlessBrowserSandbox';
    this.securityGuardrail = 'ChrootIsolationJail';
...
module.exports = { HeadlessBrowserSandboxChrootIsolationJailRuntime };
