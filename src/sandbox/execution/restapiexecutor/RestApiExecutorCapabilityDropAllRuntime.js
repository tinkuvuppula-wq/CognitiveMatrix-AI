/**
 * RestApiExecutorCapabilityDropAllRuntime.js - Sandboxed Agent Tool Execution: RestApiExecutor -> CapabilityDropAll.
 */

class RestApiExecutorCapabilityDropAllRuntime {
...
module.exports = { RestApiExecutorCapabilityDropAllRuntime };
