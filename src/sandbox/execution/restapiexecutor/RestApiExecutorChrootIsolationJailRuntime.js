/**
 * RestApiExecutorChrootIsolationJailRuntime.js - Sandboxed Agent Tool Execution: RestApiExecutor -> ChrootIsolationJail.
 */

class RestApiExecutorChrootIsolationJailRuntime {
...
module.exports = { RestApiExecutorChrootIsolationJailRuntime };
