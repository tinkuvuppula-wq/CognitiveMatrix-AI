/**
 * RestApiExecutorReadOnlyFsGuardRuntime.js - Sandboxed Agent Tool Execution: RestApiExecutor -> ReadOnlyFsGuard.
 */

class RestApiExecutorReadOnlyFsGuardRuntime {
...
module.exports = { RestApiExecutorReadOnlyFsGuardRuntime };
