/**
 * RestApiExecutorEphemeralDiskQuotaRuntime.js - Sandboxed Agent Tool Execution: RestApiExecutor -> EphemeralDiskQuota.
 */

class RestApiExecutorEphemeralDiskQuotaRuntime {
...
module.exports = { RestApiExecutorEphemeralDiskQuotaRuntime };
