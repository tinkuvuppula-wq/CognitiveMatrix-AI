/**
 * RestApiExecutorCpuQuotaGovernorRuntime.js - Sandboxed Agent Tool Execution: RestApiExecutor -> CpuQuotaGovernor.
 */

class RestApiExecutorCpuQuotaGovernorRuntime {
...
module.exports = { RestApiExecutorCpuQuotaGovernorRuntime };
