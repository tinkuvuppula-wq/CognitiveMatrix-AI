/**
 * RestApiExecutorZeroTrustSocketEnforcerRuntime.js - Sandboxed Agent Tool Execution: RestApiExecutor -> ZeroTrustSocketEnforcer.
 */

class RestApiExecutorZeroTrustSocketEnforcerRuntime {
  constructor(runtimeConfig = {}) {
    this.sandbox = 'RestApiExecutor';
...
module.exports = { RestApiExecutorZeroTrustSocketEnforcerRuntime };
