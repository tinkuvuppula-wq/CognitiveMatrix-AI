/**
 * GitWorkspaceManagerASTDangerousCallScannerRuntime.js - Sandboxed Agent Tool Execution: GitWorkspaceManager -> ASTDangerousCallScanner.
 */

class GitWorkspaceManagerASTDangerousCallScannerRuntime {
  constructor(runtimeConfig = {}) {
    this.sandbox = 'GitWorkspaceManager';
    this.securityGuardrail = 'ASTDangerousCallScanner';
    this.maxExecutionTimeoutMs = 3500;
...
module.exports = { GitWorkspaceManagerASTDangerousCallScannerRuntime };
