/**
 * PostgresSandboxASTDangerousCallScannerRuntime.js - Sandboxed Agent Tool Execution: PostgresSandbox -> ASTDangerousCallScanner.
 */

class PostgresSandboxASTDangerousCallScannerRuntime {
  constructor(runtimeConfig = {}) {
    this.sandbox = 'PostgresSandbox';
...
module.exports = { PostgresSandboxASTDangerousCallScannerRuntime };
