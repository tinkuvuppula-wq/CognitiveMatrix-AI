/**
 * PostgresSandboxSeccompSyscallGuardRuntime.js - Sandboxed Agent Tool Execution: PostgresSandbox -> SeccompSyscallGuard.
 */

class PostgresSandboxSeccompSyscallGuardRuntime {
...
module.exports = { PostgresSandboxSeccompSyscallGuardRuntime };
