/**
 * PostgresSandboxCapabilityDropAllRuntime.js - Sandboxed Agent Tool Execution: PostgresSandbox -> CapabilityDropAll.
 */

class PostgresSandboxCapabilityDropAllRuntime {
...
module.exports = { PostgresSandboxCapabilityDropAllRuntime };
