/**
 * PostgresSandboxProcessPidLimiterRuntime.js - Sandboxed Agent Tool Execution: PostgresSandbox -> ProcessPidLimiter.
 */

class PostgresSandboxProcessPidLimiterRuntime {
...
module.exports = { PostgresSandboxProcessPidLimiterRuntime };
