/**
 * PostgresSandboxEnvSecretScrubberRuntime.js - Sandboxed Agent Tool Execution: PostgresSandbox -> EnvSecretScrubber.
 */

class PostgresSandboxEnvSecretScrubberRuntime {
...
module.exports = { PostgresSandboxEnvSecretScrubberRuntime };
