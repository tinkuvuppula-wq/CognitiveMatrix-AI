/**
 * PostgresSandboxReadOnlyFsGuardRuntime.js - Sandboxed Agent Tool Execution: PostgresSandbox -> ReadOnlyFsGuard.
 */

class PostgresSandboxReadOnlyFsGuardRuntime {
...
module.exports = { PostgresSandboxReadOnlyFsGuardRuntime };
