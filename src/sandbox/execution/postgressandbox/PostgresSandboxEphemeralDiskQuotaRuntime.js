/**
 * PostgresSandboxEphemeralDiskQuotaRuntime.js - Sandboxed Agent Tool Execution: PostgresSandbox -> EphemeralDiskQuota.
 */

class PostgresSandboxEphemeralDiskQuotaRuntime {
...
module.exports = { PostgresSandboxEphemeralDiskQuotaRuntime };
