/**
 * PostgresSandboxSyslogAuditStreamRuntime.js - Sandboxed Agent Tool Execution: PostgresSandbox -> SyslogAuditStream.
 */

class PostgresSandboxSyslogAuditStreamRuntime {
...
module.exports = { PostgresSandboxSyslogAuditStreamRuntime };
