/**
 * LuceneSearchIndexReadOnlyFsGuardRuntime.js - Sandboxed Agent Tool Execution: LuceneSearchIndex -> ReadOnlyFsGuard.
 */

class LuceneSearchIndexReadOnlyFsGuardRuntime {
...
module.exports = { LuceneSearchIndexReadOnlyFsGuardRuntime };
