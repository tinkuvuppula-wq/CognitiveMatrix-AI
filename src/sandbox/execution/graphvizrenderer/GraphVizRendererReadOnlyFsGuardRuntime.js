/**
 * GraphVizRendererReadOnlyFsGuardRuntime.js - Sandboxed Agent Tool Execution: GraphVizRenderer -> ReadOnlyFsGuard.
 */

class GraphVizRendererReadOnlyFsGuardRuntime {
...
module.exports = { GraphVizRendererReadOnlyFsGuardRuntime };
