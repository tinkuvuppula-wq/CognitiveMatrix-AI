/**
 * GraphVizRendererEphemeralDiskQuotaRuntime.js - Sandboxed Agent Tool Execution: GraphVizRenderer -> EphemeralDiskQuota.
 */

class GraphVizRendererEphemeralDiskQuotaRuntime {
...
module.exports = { GraphVizRendererEphemeralDiskQuotaRuntime };
