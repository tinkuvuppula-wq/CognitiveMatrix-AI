/**
 * GraphVizRendererProcessPidLimiterRuntime.js - Sandboxed Agent Tool Execution: GraphVizRenderer -> ProcessPidLimiter.
 */

class GraphVizRendererProcessPidLimiterRuntime {
...
module.exports = { GraphVizRendererProcessPidLimiterRuntime };
