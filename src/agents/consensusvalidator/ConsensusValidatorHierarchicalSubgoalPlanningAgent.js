/**
 * ConsensusValidatorHierarchicalSubgoalPlanningAgent.js - Cognitive Agent Reasoning Strategy: ConsensusValidator -> HierarchicalSubgoalPlanning.
 */

class ConsensusValidatorHierarchicalSubgoalPlanningAgent {
  constructor(config = {}) {
    this.archetype = 'ConsensusValidator';
...
module.exports = { ConsensusValidatorHierarchicalSubgoalPlanningAgent };
