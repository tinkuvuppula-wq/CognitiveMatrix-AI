/**
 * NeuralCoderHierarchicalSubgoalPlanningAgent.js - Cognitive Agent Reasoning Strategy: NeuralCoder -> HierarchicalSubgoalPlanning.
 */

class NeuralCoderHierarchicalSubgoalPlanningAgent {
  constructor(config = {}) {
    this.archetype = 'NeuralCoder';
...
module.exports = { NeuralCoderHierarchicalSubgoalPlanningAgent };
