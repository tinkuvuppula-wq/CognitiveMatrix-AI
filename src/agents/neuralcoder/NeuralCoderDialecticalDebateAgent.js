/**
 * NeuralCoderDialecticalDebateAgent.js - Cognitive Agent Reasoning Strategy: NeuralCoder -> DialecticalDebate.
 */

class NeuralCoderDialecticalDebateAgent {
  constructor(config = {}) {
...
module.exports = { NeuralCoderDialecticalDebateAgent };
