/**
 * NeuralCoderGraphOfThoughtsAgent.js - Cognitive Agent Reasoning Strategy: NeuralCoder -> GraphOfThoughts.
 */

class NeuralCoderGraphOfThoughtsAgent {
  constructor(config = {}) {
...
module.exports = { NeuralCoderGraphOfThoughtsAgent };
