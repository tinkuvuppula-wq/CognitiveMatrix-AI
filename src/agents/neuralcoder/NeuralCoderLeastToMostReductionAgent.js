/**
 * NeuralCoderLeastToMostReductionAgent.js - Cognitive Agent Reasoning Strategy: NeuralCoder -> LeastToMostReduction.
 */

class NeuralCoderLeastToMostReductionAgent {
  constructor(config = {}) {
...
module.exports = { NeuralCoderLeastToMostReductionAgent };
