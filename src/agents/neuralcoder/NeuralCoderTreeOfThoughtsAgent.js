/**
 * NeuralCoderTreeOfThoughtsAgent.js - Cognitive Agent Reasoning Strategy: NeuralCoder -> TreeOfThoughts.
 */

class NeuralCoderTreeOfThoughtsAgent {
  constructor(config = {}) {
...
module.exports = { NeuralCoderTreeOfThoughtsAgent };
