/**
 * KnowledgeMinerTreeOfThoughtsAgent.js - Cognitive Agent Reasoning Strategy: KnowledgeMiner -> TreeOfThoughts.
 */

class KnowledgeMinerTreeOfThoughtsAgent {
  constructor(config = {}) {
...
module.exports = { KnowledgeMinerTreeOfThoughtsAgent };
