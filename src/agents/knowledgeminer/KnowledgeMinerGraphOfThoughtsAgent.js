/**
 * KnowledgeMinerGraphOfThoughtsAgent.js - Cognitive Agent Reasoning Strategy: KnowledgeMiner -> GraphOfThoughts.
 */

class KnowledgeMinerGraphOfThoughtsAgent {
  constructor(config = {}) {
...
module.exports = { KnowledgeMinerGraphOfThoughtsAgent };
