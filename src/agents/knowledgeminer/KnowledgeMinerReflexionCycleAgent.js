/**
 * KnowledgeMinerReflexionCycleAgent.js - Cognitive Agent Reasoning Strategy: KnowledgeMiner -> ReflexionCycle.
 */

class KnowledgeMinerReflexionCycleAgent {
  constructor(config = {}) {
...
module.exports = { KnowledgeMinerReflexionCycleAgent };
