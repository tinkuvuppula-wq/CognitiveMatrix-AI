/**
 * KnowledgeMinerMonteCarloReasoningAgent.js - Cognitive Agent Reasoning Strategy: KnowledgeMiner -> MonteCarloReasoning.
 */

class KnowledgeMinerMonteCarloReasoningAgent {
  constructor(config = {}) {
...
module.exports = { KnowledgeMinerMonteCarloReasoningAgent };
