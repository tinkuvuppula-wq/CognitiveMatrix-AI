/**
 * EpisodicMemoryAgentHierarchicalSubgoalPlanningAgent.js - Cognitive Agent Reasoning Strategy: EpisodicMemoryAgent -> HierarchicalSubgoalPlanning.
 */

class EpisodicMemoryAgentHierarchicalSubgoalPlanningAgent {
  constructor(config = {}) {
    this.archetype = 'EpisodicMemoryAgent';
...
module.exports = { EpisodicMemoryAgentHierarchicalSubgoalPlanningAgent };
