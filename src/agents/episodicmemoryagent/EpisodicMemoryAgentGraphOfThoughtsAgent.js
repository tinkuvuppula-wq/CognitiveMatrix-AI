/**
 * EpisodicMemoryAgentGraphOfThoughtsAgent.js - Cognitive Agent Reasoning Strategy: EpisodicMemoryAgent -> GraphOfThoughts.
 */

class EpisodicMemoryAgentGraphOfThoughtsAgent {
  constructor(config = {}) {
...
module.exports = { EpisodicMemoryAgentGraphOfThoughtsAgent };
