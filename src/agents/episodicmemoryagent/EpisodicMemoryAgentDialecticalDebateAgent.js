/**
 * EpisodicMemoryAgentDialecticalDebateAgent.js - Cognitive Agent Reasoning Strategy: EpisodicMemoryAgent -> DialecticalDebate.
 */

class EpisodicMemoryAgentDialecticalDebateAgent {
  constructor(config = {}) {
...
module.exports = { EpisodicMemoryAgentDialecticalDebateAgent };
