/**
 * ReflectiveCriticHierarchicalSubgoalPlanningAgent.js - Cognitive Agent Reasoning Strategy: ReflectiveCritic -> HierarchicalSubgoalPlanning.
 */

class ReflectiveCriticHierarchicalSubgoalPlanningAgent {
  constructor(config = {}) {
    this.archetype = 'ReflectiveCritic';
...
module.exports = { ReflectiveCriticHierarchicalSubgoalPlanningAgent };
