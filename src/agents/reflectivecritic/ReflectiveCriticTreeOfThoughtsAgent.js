/**
 * ReflectiveCriticTreeOfThoughtsAgent.js - Cognitive Agent Reasoning Strategy: ReflectiveCritic -> TreeOfThoughts.
 */

class ReflectiveCriticTreeOfThoughtsAgent {
  constructor(config = {}) {
...
module.exports = { ReflectiveCriticTreeOfThoughtsAgent };
