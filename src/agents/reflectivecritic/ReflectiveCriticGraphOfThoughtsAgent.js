/**
 * ReflectiveCriticGraphOfThoughtsAgent.js - Cognitive Agent Reasoning Strategy: ReflectiveCritic -> GraphOfThoughts.
 */

class ReflectiveCriticGraphOfThoughtsAgent {
  constructor(config = {}) {
...
module.exports = { ReflectiveCriticGraphOfThoughtsAgent };
