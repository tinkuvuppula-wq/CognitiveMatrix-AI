/**
 * ReflectiveCriticReActLoopAgent.js - Cognitive Agent Reasoning Strategy: ReflectiveCritic -> ReActLoop.
 */

class ReflectiveCriticReActLoopAgent {
  constructor(config = {}) {
...
module.exports = { ReflectiveCriticReActLoopAgent };
