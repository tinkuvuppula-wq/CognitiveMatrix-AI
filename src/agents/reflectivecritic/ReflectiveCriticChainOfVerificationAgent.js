/**
 * ReflectiveCriticChainOfVerificationAgent.js - Cognitive Agent Reasoning Strategy: ReflectiveCritic -> ChainOfVerification.
 */

class ReflectiveCriticChainOfVerificationAgent {
  constructor(config = {}) {
...
module.exports = { ReflectiveCriticChainOfVerificationAgent };
