/**
 * ReflectiveCriticReflexionCycleAgent.js - Cognitive Agent Reasoning Strategy: ReflectiveCritic -> ReflexionCycle.
 */

class ReflectiveCriticReflexionCycleAgent {
  constructor(config = {}) {
...
module.exports = { ReflectiveCriticReflexionCycleAgent };
