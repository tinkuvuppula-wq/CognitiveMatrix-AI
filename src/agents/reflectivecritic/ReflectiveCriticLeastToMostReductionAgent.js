/**
 * ReflectiveCriticLeastToMostReductionAgent.js - Cognitive Agent Reasoning Strategy: ReflectiveCritic -> LeastToMostReduction.
 */

class ReflectiveCriticLeastToMostReductionAgent {
  constructor(config = {}) {
...
module.exports = { ReflectiveCriticLeastToMostReductionAgent };
