/**
 * ReflectiveCriticContrastiveSearchAgent.js - Cognitive Agent Reasoning Strategy: ReflectiveCritic -> ContrastiveSearch.
 */

class ReflectiveCriticContrastiveSearchAgent {
  constructor(config = {}) {
...
module.exports = { ReflectiveCriticContrastiveSearchAgent };
