/**
 * ReflectiveCriticStepBackAbstractionAgent.js - Cognitive Agent Reasoning Strategy: ReflectiveCritic -> StepBackAbstraction.
 */

class ReflectiveCriticStepBackAbstractionAgent {
  constructor(config = {}) {
...
module.exports = { ReflectiveCriticStepBackAbstractionAgent };
