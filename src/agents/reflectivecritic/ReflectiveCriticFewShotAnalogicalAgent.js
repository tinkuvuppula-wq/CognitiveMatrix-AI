/**
 * ReflectiveCriticFewShotAnalogicalAgent.js - Cognitive Agent Reasoning Strategy: ReflectiveCritic -> FewShotAnalogical.
 */

class ReflectiveCriticFewShotAnalogicalAgent {
  constructor(config = {}) {
...
module.exports = { ReflectiveCriticFewShotAnalogicalAgent };
