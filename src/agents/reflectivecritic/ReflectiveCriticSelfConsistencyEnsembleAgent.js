/**
 * ReflectiveCriticSelfConsistencyEnsembleAgent.js - Cognitive Agent Reasoning Strategy: ReflectiveCritic -> SelfConsistencyEnsemble.
 */

class ReflectiveCriticSelfConsistencyEnsembleAgent {
  constructor(config = {}) {
...
module.exports = { ReflectiveCriticSelfConsistencyEnsembleAgent };
