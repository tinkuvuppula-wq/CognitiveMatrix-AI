/**
 * ReflectiveCriticDialecticalDebateAgent.js - Cognitive Agent Reasoning Strategy: ReflectiveCritic -> DialecticalDebate.
 */

class ReflectiveCriticDialecticalDebateAgent {
  constructor(config = {}) {
...
module.exports = { ReflectiveCriticDialecticalDebateAgent };
