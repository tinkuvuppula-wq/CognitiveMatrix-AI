/**
 * VectorSearcherTreeOfThoughtsAgent.js - Cognitive Agent Reasoning Strategy: VectorSearcher -> TreeOfThoughts.
 */

class VectorSearcherTreeOfThoughtsAgent {
  constructor(config = {}) {
...
module.exports = { VectorSearcherTreeOfThoughtsAgent };
