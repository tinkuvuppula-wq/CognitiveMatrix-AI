/**
 * VectorSearcherGraphOfThoughtsAgent.js - Cognitive Agent Reasoning Strategy: VectorSearcher -> GraphOfThoughts.
 */

class VectorSearcherGraphOfThoughtsAgent {
  constructor(config = {}) {
...
module.exports = { VectorSearcherGraphOfThoughtsAgent };
