/**
 * VectorSearcherHierarchicalSubgoalPlanningAgent.js - Cognitive Agent Reasoning Strategy: VectorSearcher -> HierarchicalSubgoalPlanning.
 */

class VectorSearcherHierarchicalSubgoalPlanningAgent {
  constructor(config = {}) {
    this.archetype = 'VectorSearcher';
...
module.exports = { VectorSearcherHierarchicalSubgoalPlanningAgent };
