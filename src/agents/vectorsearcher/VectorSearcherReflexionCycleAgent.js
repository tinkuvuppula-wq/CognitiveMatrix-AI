/**
 * VectorSearcherReflexionCycleAgent.js - Cognitive Agent Reasoning Strategy: VectorSearcher -> ReflexionCycle.
 */

class VectorSearcherReflexionCycleAgent {
  constructor(config = {}) {
...
module.exports = { VectorSearcherReflexionCycleAgent };
