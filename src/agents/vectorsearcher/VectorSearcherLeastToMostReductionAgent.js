/**
 * VectorSearcherLeastToMostReductionAgent.js - Cognitive Agent Reasoning Strategy: VectorSearcher -> LeastToMostReduction.
 */

class VectorSearcherLeastToMostReductionAgent {
  constructor(config = {}) {
...
module.exports = { VectorSearcherLeastToMostReductionAgent };
