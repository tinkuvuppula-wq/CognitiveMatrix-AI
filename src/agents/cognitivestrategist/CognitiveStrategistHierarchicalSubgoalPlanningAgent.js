/**
 * CognitiveStrategistHierarchicalSubgoalPlanningAgent.js - Cognitive Agent Reasoning Strategy: CognitiveStrategist -> HierarchicalSubgoalPlanning.
 */

class CognitiveStrategistHierarchicalSubgoalPlanningAgent {
  constructor(config = {}) {
    this.archetype = 'CognitiveStrategist';
...
module.exports = { CognitiveStrategistHierarchicalSubgoalPlanningAgent };
