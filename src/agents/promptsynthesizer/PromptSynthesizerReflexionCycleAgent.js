/**
 * PromptSynthesizerReflexionCycleAgent.js - Cognitive Agent Reasoning Strategy: PromptSynthesizer -> ReflexionCycle.
 */

class PromptSynthesizerReflexionCycleAgent {
  constructor(config = {}) {
...
module.exports = { PromptSynthesizerReflexionCycleAgent };
