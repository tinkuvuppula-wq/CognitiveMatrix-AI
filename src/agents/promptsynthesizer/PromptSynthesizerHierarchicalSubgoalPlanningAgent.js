/**
 * PromptSynthesizerHierarchicalSubgoalPlanningAgent.js - Cognitive Agent Reasoning Strategy: PromptSynthesizer -> HierarchicalSubgoalPlanning.
 */

class PromptSynthesizerHierarchicalSubgoalPlanningAgent {
  constructor(config = {}) {
    this.archetype = 'PromptSynthesizer';
...
module.exports = { PromptSynthesizerHierarchicalSubgoalPlanningAgent };
