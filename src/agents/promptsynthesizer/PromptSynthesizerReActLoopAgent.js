/**
 * PromptSynthesizerReActLoopAgent.js - Cognitive Agent Reasoning Strategy: PromptSynthesizer -> ReActLoop.
 */

class PromptSynthesizerReActLoopAgent {
  constructor(config = {}) {
...
module.exports = { PromptSynthesizerReActLoopAgent };
