/**
 * PromptSynthesizerLeastToMostReductionAgent.js - Cognitive Agent Reasoning Strategy: PromptSynthesizer -> LeastToMostReduction.
 */

class PromptSynthesizerLeastToMostReductionAgent {
  constructor(config = {}) {
...
module.exports = { PromptSynthesizerLeastToMostReductionAgent };
