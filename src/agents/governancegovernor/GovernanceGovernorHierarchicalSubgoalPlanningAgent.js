/**
 * GovernanceGovernorHierarchicalSubgoalPlanningAgent.js - Cognitive Agent Reasoning Strategy: GovernanceGovernor -> HierarchicalSubgoalPlanning.
 */

class GovernanceGovernorHierarchicalSubgoalPlanningAgent {
  constructor(config = {}) {
    this.archetype = 'GovernanceGovernor';
...
module.exports = { GovernanceGovernorHierarchicalSubgoalPlanningAgent };
