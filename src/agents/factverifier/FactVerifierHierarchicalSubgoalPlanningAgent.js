/**
 * FactVerifierHierarchicalSubgoalPlanningAgent.js - Cognitive Agent Reasoning Strategy: FactVerifier -> HierarchicalSubgoalPlanning.
 */

class FactVerifierHierarchicalSubgoalPlanningAgent {
  constructor(config = {}) {
    this.archetype = 'FactVerifier';
...
module.exports = { FactVerifierHierarchicalSubgoalPlanningAgent };
