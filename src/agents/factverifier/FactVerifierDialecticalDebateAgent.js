/**
 * FactVerifierDialecticalDebateAgent.js - Cognitive Agent Reasoning Strategy: FactVerifier -> DialecticalDebate.
 */

class FactVerifierDialecticalDebateAgent {
  constructor(config = {}) {
...
module.exports = { FactVerifierDialecticalDebateAgent };
