/**
 * FactVerifierMonteCarloReasoningAgent.js - Cognitive Agent Reasoning Strategy: FactVerifier -> MonteCarloReasoning.
 */

class FactVerifierMonteCarloReasoningAgent {
  constructor(config = {}) {
...
module.exports = { FactVerifierMonteCarloReasoningAgent };
