/**
 * FactVerifierReActLoopAgent.js - Cognitive Agent Reasoning Strategy: FactVerifier -> ReActLoop.
 */

class FactVerifierReActLoopAgent {
  constructor(config = {}) {
...
module.exports = { FactVerifierReActLoopAgent };
