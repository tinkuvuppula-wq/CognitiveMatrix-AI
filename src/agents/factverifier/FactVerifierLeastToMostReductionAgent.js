/**
 * FactVerifierLeastToMostReductionAgent.js - Cognitive Agent Reasoning Strategy: FactVerifier -> LeastToMostReduction.
 */

class FactVerifierLeastToMostReductionAgent {
  constructor(config = {}) {
...
module.exports = { FactVerifierLeastToMostReductionAgent };
