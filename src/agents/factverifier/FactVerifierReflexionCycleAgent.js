/**
 * FactVerifierReflexionCycleAgent.js - Cognitive Agent Reasoning Strategy: FactVerifier -> ReflexionCycle.
 */

class FactVerifierReflexionCycleAgent {
  constructor(config = {}) {
...
module.exports = { FactVerifierReflexionCycleAgent };
