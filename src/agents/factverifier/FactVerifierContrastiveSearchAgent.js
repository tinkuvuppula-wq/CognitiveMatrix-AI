/**
 * FactVerifierContrastiveSearchAgent.js - Cognitive Agent Reasoning Strategy: FactVerifier -> ContrastiveSearch.
 */

class FactVerifierContrastiveSearchAgent {
  constructor(config = {}) {
...
module.exports = { FactVerifierContrastiveSearchAgent };
