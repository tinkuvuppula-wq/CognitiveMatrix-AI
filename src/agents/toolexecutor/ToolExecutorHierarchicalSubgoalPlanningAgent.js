/**
 * ToolExecutorHierarchicalSubgoalPlanningAgent.js - Cognitive Agent Reasoning Strategy: ToolExecutor -> HierarchicalSubgoalPlanning.
 */

class ToolExecutorHierarchicalSubgoalPlanningAgent {
  constructor(config = {}) {
    this.archetype = 'ToolExecutor';
...
module.exports = { ToolExecutorHierarchicalSubgoalPlanningAgent };
