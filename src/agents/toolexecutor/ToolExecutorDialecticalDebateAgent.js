/**
 * ToolExecutorDialecticalDebateAgent.js - Cognitive Agent Reasoning Strategy: ToolExecutor -> DialecticalDebate.
 */

class ToolExecutorDialecticalDebateAgent {
  constructor(config = {}) {
...
module.exports = { ToolExecutorDialecticalDebateAgent };
