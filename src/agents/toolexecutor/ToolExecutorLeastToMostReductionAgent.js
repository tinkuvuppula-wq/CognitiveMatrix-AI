/**
 * ToolExecutorLeastToMostReductionAgent.js - Cognitive Agent Reasoning Strategy: ToolExecutor -> LeastToMostReduction.
 */

class ToolExecutorLeastToMostReductionAgent {
  constructor(config = {}) {
...
module.exports = { ToolExecutorLeastToMostReductionAgent };
