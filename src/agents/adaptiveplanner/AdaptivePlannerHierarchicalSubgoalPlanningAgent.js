/**
 * AdaptivePlannerHierarchicalSubgoalPlanningAgent.js - Cognitive Agent Reasoning Strategy: AdaptivePlanner -> HierarchicalSubgoalPlanning.
 */

class AdaptivePlannerHierarchicalSubgoalPlanningAgent {
  constructor(config = {}) {
    this.archetype = 'AdaptivePlanner';
...
module.exports = { AdaptivePlannerHierarchicalSubgoalPlanningAgent };
