/**
 * AdaptivePlannerLeastToMostReductionAgent.js - Cognitive Agent Reasoning Strategy: AdaptivePlanner -> LeastToMostReduction.
 */

class AdaptivePlannerLeastToMostReductionAgent {
  constructor(config = {}) {
...
module.exports = { AdaptivePlannerLeastToMostReductionAgent };
