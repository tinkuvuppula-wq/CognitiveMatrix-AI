/**
 * AdaptivePlannerSelfConsistencyEnsembleAgent.js - Cognitive Agent Reasoning Strategy: AdaptivePlanner -> SelfConsistencyEnsemble.
 */

class AdaptivePlannerSelfConsistencyEnsembleAgent {
  constructor(config = {}) {
...
module.exports = { AdaptivePlannerSelfConsistencyEnsembleAgent };
