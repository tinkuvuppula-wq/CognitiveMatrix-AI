/**
 * AdaptivePlannerBayesianBeliefUpdateAgent.js - Cognitive Agent Reasoning Strategy: AdaptivePlanner -> BayesianBeliefUpdate.
 */

class AdaptivePlannerBayesianBeliefUpdateAgent {
  constructor(config = {}) {
...
module.exports = { AdaptivePlannerBayesianBeliefUpdateAgent };
