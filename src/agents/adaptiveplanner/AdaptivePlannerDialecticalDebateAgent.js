/**
 * AdaptivePlannerDialecticalDebateAgent.js - Cognitive Agent Reasoning Strategy: AdaptivePlanner -> DialecticalDebate.
 */

class AdaptivePlannerDialecticalDebateAgent {
  constructor(config = {}) {
...
module.exports = { AdaptivePlannerDialecticalDebateAgent };
