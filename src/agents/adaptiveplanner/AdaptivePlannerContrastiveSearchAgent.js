/**
 * AdaptivePlannerContrastiveSearchAgent.js - Cognitive Agent Reasoning Strategy: AdaptivePlanner -> ContrastiveSearch.
 */

class AdaptivePlannerContrastiveSearchAgent {
  constructor(config = {}) {
...
module.exports = { AdaptivePlannerContrastiveSearchAgent };
