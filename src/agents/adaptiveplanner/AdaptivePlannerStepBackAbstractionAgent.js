/**
 * AdaptivePlannerStepBackAbstractionAgent.js - Cognitive Agent Reasoning Strategy: AdaptivePlanner -> StepBackAbstraction.
 */

class AdaptivePlannerStepBackAbstractionAgent {
  constructor(config = {}) {
...
module.exports = { AdaptivePlannerStepBackAbstractionAgent };
