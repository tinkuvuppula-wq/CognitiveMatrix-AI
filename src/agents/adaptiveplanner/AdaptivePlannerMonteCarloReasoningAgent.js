/**
 * AdaptivePlannerMonteCarloReasoningAgent.js - Cognitive Agent Reasoning Strategy: AdaptivePlanner -> MonteCarloReasoning.
 */

class AdaptivePlannerMonteCarloReasoningAgent {
  constructor(config = {}) {
...
module.exports = { AdaptivePlannerMonteCarloReasoningAgent };
