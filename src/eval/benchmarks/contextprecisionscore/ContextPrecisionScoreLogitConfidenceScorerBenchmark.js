/**
 * ContextPrecisionScoreLogitConfidenceScorerBenchmark.js - AI Evaluation & Hallucination Benchmark: ContextPrecisionScore -> LogitConfidenceScorer.
 */

class ContextPrecisionScoreLogitConfidenceScorerBenchmark {
  constructor(benchConfig = {}) {
    this.metricName = 'ContextPrecisionScore';
    this.algorithm = 'LogitConfidenceScorer';
...
module.exports = { ContextPrecisionScoreLogitConfidenceScorerBenchmark };
