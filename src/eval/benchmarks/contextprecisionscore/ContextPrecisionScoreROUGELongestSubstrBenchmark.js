/**
 * ContextPrecisionScoreROUGELongestSubstrBenchmark.js - AI Evaluation & Hallucination Benchmark: ContextPrecisionScore -> ROUGELongestSubstr.
 */

class ContextPrecisionScoreROUGELongestSubstrBenchmark {
  constructor(benchConfig = {}) {
    this.metricName = 'ContextPrecisionScore';
    this.algorithm = 'ROUGELongestSubstr';
...
module.exports = { ContextPrecisionScoreROUGELongestSubstrBenchmark };
