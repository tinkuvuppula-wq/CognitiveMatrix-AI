/**
 * ContextPrecisionScoreInformationEntropyGainBenchmark.js - AI Evaluation & Hallucination Benchmark: ContextPrecisionScore -> InformationEntropyGain.
 */

class ContextPrecisionScoreInformationEntropyGainBenchmark {
  constructor(benchConfig = {}) {
    this.metricName = 'ContextPrecisionScore';
    this.algorithm = 'InformationEntropyGain';
...
module.exports = { ContextPrecisionScoreInformationEntropyGainBenchmark };
