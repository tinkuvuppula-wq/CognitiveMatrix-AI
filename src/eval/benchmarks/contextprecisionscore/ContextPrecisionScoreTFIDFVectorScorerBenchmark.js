/**
 * ContextPrecisionScoreTFIDFVectorScorerBenchmark.js - AI Evaluation & Hallucination Benchmark: ContextPrecisionScore -> TFIDFVectorScorer.
 */

class ContextPrecisionScoreTFIDFVectorScorerBenchmark {
  constructor(benchConfig = {}) {
    this.metricName = 'ContextPrecisionScore';
    this.algorithm = 'TFIDFVectorScorer';
...
module.exports = { ContextPrecisionScoreTFIDFVectorScorerBenchmark };
