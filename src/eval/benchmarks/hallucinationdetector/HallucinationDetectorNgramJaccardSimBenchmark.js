/**
 * HallucinationDetectorNgramJaccardSimBenchmark.js - AI Evaluation & Hallucination Benchmark: HallucinationDetector -> NgramJaccardSim.
 */

class HallucinationDetectorNgramJaccardSimBenchmark {
  constructor(benchConfig = {}) {
    this.metricName = 'HallucinationDetector';
    this.algorithm = 'NgramJaccardSim';
...
module.exports = { HallucinationDetectorNgramJaccardSimBenchmark };
