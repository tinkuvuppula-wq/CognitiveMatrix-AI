/**
 * HallucinationDetectorContrastiveScorerBenchmark.js - AI Evaluation & Hallucination Benchmark: HallucinationDetector -> ContrastiveScorer.
 */

class HallucinationDetectorContrastiveScorerBenchmark {
  constructor(benchConfig = {}) {
    this.metricName = 'HallucinationDetector';
    this.algorithm = 'ContrastiveScorer';
...
module.exports = { HallucinationDetectorContrastiveScorerBenchmark };
