/**
 * ROUGEOverlapScoreSentimentAlignmentScoreBenchmark.js - AI Evaluation & Hallucination Benchmark: ROUGEOverlapScore -> SentimentAlignmentScore.
 */

class ROUGEOverlapScoreSentimentAlignmentScoreBenchmark {
  constructor(benchConfig = {}) {
    this.metricName = 'ROUGEOverlapScore';
...
module.exports = { ROUGEOverlapScoreSentimentAlignmentScoreBenchmark };
