/**
 * GroundednessRatioSentimentAlignmentScoreBenchmark.js - AI Evaluation & Hallucination Benchmark: GroundednessRatio -> SentimentAlignmentScore.
 */

class GroundednessRatioSentimentAlignmentScoreBenchmark {
  constructor(benchConfig = {}) {
    this.metricName = 'GroundednessRatio';
...
module.exports = { GroundednessRatioSentimentAlignmentScoreBenchmark };
