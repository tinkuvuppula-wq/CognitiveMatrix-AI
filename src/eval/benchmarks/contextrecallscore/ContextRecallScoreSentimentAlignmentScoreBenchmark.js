/**
 * ContextRecallScoreSentimentAlignmentScoreBenchmark.js - AI Evaluation & Hallucination Benchmark: ContextRecallScore -> SentimentAlignmentScore.
 */

class ContextRecallScoreSentimentAlignmentScoreBenchmark {
  constructor(benchConfig = {}) {
    this.metricName = 'ContextRecallScore';
...
module.exports = { ContextRecallScoreSentimentAlignmentScoreBenchmark };
