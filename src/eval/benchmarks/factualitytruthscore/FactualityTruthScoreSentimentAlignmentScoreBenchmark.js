/**
 * FactualityTruthScoreSentimentAlignmentScoreBenchmark.js - AI Evaluation & Hallucination Benchmark: FactualityTruthScore -> SentimentAlignmentScore.
 */

class FactualityTruthScoreSentimentAlignmentScoreBenchmark {
  constructor(benchConfig = {}) {
    this.metricName = 'FactualityTruthScore';
...
module.exports = { FactualityTruthScoreSentimentAlignmentScoreBenchmark };
