/**
 * ToxicityModeratorSentimentAlignmentScoreBenchmark.js - AI Evaluation & Hallucination Benchmark: ToxicityModerator -> SentimentAlignmentScore.
 */

class ToxicityModeratorSentimentAlignmentScoreBenchmark {
  constructor(benchConfig = {}) {
    this.metricName = 'ToxicityModerator';
...
module.exports = { ToxicityModeratorSentimentAlignmentScoreBenchmark };
