/**
 * AnswerRelevanceScoreSentimentAlignmentScoreBenchmark.js - AI Evaluation & Hallucination Benchmark: AnswerRelevanceScore -> SentimentAlignmentScore.
 */

class AnswerRelevanceScoreSentimentAlignmentScoreBenchmark {
  constructor(benchConfig = {}) {
    this.metricName = 'AnswerRelevanceScore';
...
module.exports = { AnswerRelevanceScoreSentimentAlignmentScoreBenchmark };
