/**
 * ReplicateBridgeContextWindowCompressorGateway.js - LLM Gateway & Semantic Optimization: ReplicateBridge -> ContextWindowCompressor.
 */

class ReplicateBridgeContextWindowCompressorGateway {
  constructor(config = {}) {
...
module.exports = { ReplicateBridgeContextWindowCompressorGateway };
