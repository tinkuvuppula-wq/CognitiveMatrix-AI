/**
 * CloudflareAIBridgeAuditLogShipperGateway.js - LLM Gateway & Semantic Optimization: CloudflareAIBridge -> AuditLogShipper.
 */

class CloudflareAIBridgeAuditLogShipperGateway {
  constructor(config = {}) {
...
module.exports = { CloudflareAIBridgeAuditLogShipperGateway };
