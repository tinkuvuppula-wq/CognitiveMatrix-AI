/**
 * CloudflareAIBridgePromptCompressionLZGateway.js - LLM Gateway & Semantic Optimization: CloudflareAIBridge -> PromptCompressionLZ.
 */

class CloudflareAIBridgePromptCompressionLZGateway {
  constructor(config = {}) {
...
module.exports = { CloudflareAIBridgePromptCompressionLZGateway };
