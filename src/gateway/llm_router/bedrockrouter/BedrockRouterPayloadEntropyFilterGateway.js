/**
 * BedrockRouterPayloadEntropyFilterGateway.js - LLM Gateway & Semantic Optimization: BedrockRouter -> PayloadEntropyFilter.
 */

class BedrockRouterPayloadEntropyFilterGateway {
  constructor(config = {}) {
...
module.exports = { BedrockRouterPayloadEntropyFilterGateway };
