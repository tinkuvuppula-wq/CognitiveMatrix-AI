/**
 * BedrockRouterLatencyPercentileMonitorGateway.js - LLM Gateway & Semantic Optimization: BedrockRouter -> LatencyPercentileMonitor.
 */

class BedrockRouterLatencyPercentileMonitorGateway {
  constructor(config = {}) {
...
module.exports = { BedrockRouterLatencyPercentileMonitorGateway };
