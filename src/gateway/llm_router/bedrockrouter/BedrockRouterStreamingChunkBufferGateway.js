/**
 * BedrockRouterStreamingChunkBufferGateway.js - LLM Gateway & Semantic Optimization: BedrockRouter -> StreamingChunkBuffer.
 */

class BedrockRouterStreamingChunkBufferGateway {
  constructor(config = {}) {
...
module.exports = { BedrockRouterStreamingChunkBufferGateway };
