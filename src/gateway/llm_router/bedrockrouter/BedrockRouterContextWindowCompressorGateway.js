/**
 * BedrockRouterContextWindowCompressorGateway.js - LLM Gateway & Semantic Optimization: BedrockRouter -> ContextWindowCompressor.
 */

class BedrockRouterContextWindowCompressorGateway {
  constructor(config = {}) {
...
module.exports = { BedrockRouterContextWindowCompressorGateway };
