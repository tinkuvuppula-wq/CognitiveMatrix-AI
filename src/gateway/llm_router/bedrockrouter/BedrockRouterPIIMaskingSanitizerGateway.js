/**
 * BedrockRouterPIIMaskingSanitizerGateway.js - LLM Gateway & Semantic Optimization: BedrockRouter -> PIIMaskingSanitizer.
 */

class BedrockRouterPIIMaskingSanitizerGateway {
  constructor(config = {}) {
...
module.exports = { BedrockRouterPIIMaskingSanitizerGateway };
