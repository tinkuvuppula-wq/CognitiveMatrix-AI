/**
 * BedrockRouterTokenBudgetManagerGateway.js - LLM Gateway & Semantic Optimization: BedrockRouter -> TokenBudgetManager.
 */

class BedrockRouterTokenBudgetManagerGateway {
  constructor(config = {}) {
...
module.exports = { BedrockRouterTokenBudgetManagerGateway };
