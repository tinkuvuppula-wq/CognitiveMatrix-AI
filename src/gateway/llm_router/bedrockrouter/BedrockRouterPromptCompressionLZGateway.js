/**
 * BedrockRouterPromptCompressionLZGateway.js - LLM Gateway & Semantic Optimization: BedrockRouter -> PromptCompressionLZ.
 */

class BedrockRouterPromptCompressionLZGateway {
  constructor(config = {}) {
...
module.exports = { BedrockRouterPromptCompressionLZGateway };
