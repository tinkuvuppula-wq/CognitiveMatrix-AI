/**
 * BedrockRouterFallbackFailoverRouterGateway.js - LLM Gateway & Semantic Optimization: BedrockRouter -> FallbackFailoverRouter.
 */

class BedrockRouterFallbackFailoverRouterGateway {
  constructor(config = {}) {
...
module.exports = { BedrockRouterFallbackFailoverRouterGateway };
