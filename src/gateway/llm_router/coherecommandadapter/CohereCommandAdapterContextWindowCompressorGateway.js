/**
 * CohereCommandAdapterContextWindowCompressorGateway.js - LLM Gateway & Semantic Optimization: CohereCommandAdapter -> ContextWindowCompressor.
 */

class CohereCommandAdapterContextWindowCompressorGateway {
  constructor(config = {}) {
...
module.exports = { CohereCommandAdapterContextWindowCompressorGateway };
