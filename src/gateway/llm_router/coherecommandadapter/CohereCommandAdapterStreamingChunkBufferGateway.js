/**
 * CohereCommandAdapterStreamingChunkBufferGateway.js - LLM Gateway & Semantic Optimization: CohereCommandAdapter -> StreamingChunkBuffer.
 */

class CohereCommandAdapterStreamingChunkBufferGateway {
  constructor(config = {}) {
...
module.exports = { CohereCommandAdapterStreamingChunkBufferGateway };
