/**
 * CohereCommandAdapterPromptCompressionLZGateway.js - LLM Gateway & Semantic Optimization: CohereCommandAdapter -> PromptCompressionLZ.
 */

class CohereCommandAdapterPromptCompressionLZGateway {
  constructor(config = {}) {
...
module.exports = { CohereCommandAdapterPromptCompressionLZGateway };
