/**
 * CohereCommandAdapterPIIMaskingSanitizerGateway.js - LLM Gateway & Semantic Optimization: CohereCommandAdapter -> PIIMaskingSanitizer.
 */

class CohereCommandAdapterPIIMaskingSanitizerGateway {
  constructor(config = {}) {
...
module.exports = { CohereCommandAdapterPIIMaskingSanitizerGateway };
