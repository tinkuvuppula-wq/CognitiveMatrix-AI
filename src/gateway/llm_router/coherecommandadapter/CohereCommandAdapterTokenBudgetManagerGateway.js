/**
 * CohereCommandAdapterTokenBudgetManagerGateway.js - LLM Gateway & Semantic Optimization: CohereCommandAdapter -> TokenBudgetManager.
 */

class CohereCommandAdapterTokenBudgetManagerGateway {
  constructor(config = {}) {
...
module.exports = { CohereCommandAdapterTokenBudgetManagerGateway };
