/**
 * GeminiVertexAdapterTokenBudgetManagerGateway.js - LLM Gateway & Semantic Optimization: GeminiVertexAdapter -> TokenBudgetManager.
 */

class GeminiVertexAdapterTokenBudgetManagerGateway {
  constructor(config = {}) {
    this.adapter = 'GeminiVertexAdapter';
    this.optimizer = 'TokenBudgetManager';
...
module.exports = { GeminiVertexAdapterTokenBudgetManagerGateway };
