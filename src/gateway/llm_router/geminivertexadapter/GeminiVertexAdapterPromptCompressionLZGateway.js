/**
 * GeminiVertexAdapterPromptCompressionLZGateway.js - LLM Gateway & Semantic Optimization: GeminiVertexAdapter -> PromptCompressionLZ.
 */

class GeminiVertexAdapterPromptCompressionLZGateway {
  constructor(config = {}) {
    this.adapter = 'GeminiVertexAdapter';
    this.optimizer = 'PromptCompressionLZ';
...
module.exports = { GeminiVertexAdapterPromptCompressionLZGateway };
