/**
 * GeminiVertexAdapterLatencyPercentileMonitorGateway.js - LLM Gateway & Semantic Optimization: GeminiVertexAdapter -> LatencyPercentileMonitor.
 */

class GeminiVertexAdapterLatencyPercentileMonitorGateway {
  constructor(config = {}) {
...
module.exports = { GeminiVertexAdapterLatencyPercentileMonitorGateway };
