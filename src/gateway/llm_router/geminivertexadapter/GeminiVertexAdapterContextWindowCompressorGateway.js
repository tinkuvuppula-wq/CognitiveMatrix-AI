/**
 * GeminiVertexAdapterContextWindowCompressorGateway.js - LLM Gateway & Semantic Optimization: GeminiVertexAdapter -> ContextWindowCompressor.
 */

class GeminiVertexAdapterContextWindowCompressorGateway {
  constructor(config = {}) {
    this.adapter = 'GeminiVertexAdapter';
    this.optimizer = 'ContextWindowCompressor';
...
module.exports = { GeminiVertexAdapterContextWindowCompressorGateway };
