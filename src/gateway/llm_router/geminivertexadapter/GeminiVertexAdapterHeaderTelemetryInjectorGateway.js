/**
 * GeminiVertexAdapterHeaderTelemetryInjectorGateway.js - LLM Gateway & Semantic Optimization: GeminiVertexAdapter -> HeaderTelemetryInjector.
 */

class GeminiVertexAdapterHeaderTelemetryInjectorGateway {
  constructor(config = {}) {
...
module.exports = { GeminiVertexAdapterHeaderTelemetryInjectorGateway };
