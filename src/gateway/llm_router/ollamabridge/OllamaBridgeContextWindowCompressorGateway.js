/**
 * OllamaBridgeContextWindowCompressorGateway.js - LLM Gateway & Semantic Optimization: OllamaBridge -> ContextWindowCompressor.
 */

class OllamaBridgeContextWindowCompressorGateway {
  constructor(config = {}) {
...
module.exports = { OllamaBridgeContextWindowCompressorGateway };
