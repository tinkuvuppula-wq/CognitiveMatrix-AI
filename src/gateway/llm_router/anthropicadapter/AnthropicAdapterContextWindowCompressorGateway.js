/**
 * AnthropicAdapterContextWindowCompressorGateway.js - LLM Gateway & Semantic Optimization: AnthropicAdapter -> ContextWindowCompressor.
 */

class AnthropicAdapterContextWindowCompressorGateway {
  constructor(config = {}) {
...
module.exports = { AnthropicAdapterContextWindowCompressorGateway };
