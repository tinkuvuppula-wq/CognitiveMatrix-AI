/**
 * AnthropicAdapterFallbackFailoverRouterGateway.js - LLM Gateway & Semantic Optimization: AnthropicAdapter -> FallbackFailoverRouter.
 */

class AnthropicAdapterFallbackFailoverRouterGateway {
  constructor(config = {}) {
...
module.exports = { AnthropicAdapterFallbackFailoverRouterGateway };
