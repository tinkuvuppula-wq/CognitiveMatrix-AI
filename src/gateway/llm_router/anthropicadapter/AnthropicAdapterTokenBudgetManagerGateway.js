/**
 * AnthropicAdapterTokenBudgetManagerGateway.js - LLM Gateway & Semantic Optimization: AnthropicAdapter -> TokenBudgetManager.
 */

class AnthropicAdapterTokenBudgetManagerGateway {
  constructor(config = {}) {
...
module.exports = { AnthropicAdapterTokenBudgetManagerGateway };
