/**
 * AnthropicAdapterPayloadEntropyFilterGateway.js - LLM Gateway & Semantic Optimization: AnthropicAdapter -> PayloadEntropyFilter.
 */

class AnthropicAdapterPayloadEntropyFilterGateway {
  constructor(config = {}) {
...
module.exports = { AnthropicAdapterPayloadEntropyFilterGateway };
