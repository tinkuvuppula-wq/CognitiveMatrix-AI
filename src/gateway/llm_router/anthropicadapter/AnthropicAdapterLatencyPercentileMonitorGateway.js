/**
 * AnthropicAdapterLatencyPercentileMonitorGateway.js - LLM Gateway & Semantic Optimization: AnthropicAdapter -> LatencyPercentileMonitor.
 */

class AnthropicAdapterLatencyPercentileMonitorGateway {
  constructor(config = {}) {
...
module.exports = { AnthropicAdapterLatencyPercentileMonitorGateway };
