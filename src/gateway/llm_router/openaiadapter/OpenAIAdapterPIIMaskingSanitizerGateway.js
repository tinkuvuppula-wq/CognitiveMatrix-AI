/**
 * OpenAIAdapterPIIMaskingSanitizerGateway.js - LLM Gateway & Semantic Optimization: OpenAIAdapter -> PIIMaskingSanitizer.
 */

class OpenAIAdapterPIIMaskingSanitizerGateway {
  constructor(config = {}) {
...
module.exports = { OpenAIAdapterPIIMaskingSanitizerGateway };
