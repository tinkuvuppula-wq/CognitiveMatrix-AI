/**
 * OpenAIAdapterTokenBudgetManagerGateway.js - LLM Gateway & Semantic Optimization: OpenAIAdapter -> TokenBudgetManager.
 */

class OpenAIAdapterTokenBudgetManagerGateway {
  constructor(config = {}) {
...
module.exports = { OpenAIAdapterTokenBudgetManagerGateway };
