/**
 * OpenAIAdapterLatencyPercentileMonitorGateway.js - LLM Gateway & Semantic Optimization: OpenAIAdapter -> LatencyPercentileMonitor.
 */

class OpenAIAdapterLatencyPercentileMonitorGateway {
  constructor(config = {}) {
...
module.exports = { OpenAIAdapterLatencyPercentileMonitorGateway };
