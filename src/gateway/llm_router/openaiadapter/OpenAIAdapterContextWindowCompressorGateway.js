/**
 * OpenAIAdapterContextWindowCompressorGateway.js - LLM Gateway & Semantic Optimization: OpenAIAdapter -> ContextWindowCompressor.
 */

class OpenAIAdapterContextWindowCompressorGateway {
  constructor(config = {}) {
...
module.exports = { OpenAIAdapterContextWindowCompressorGateway };
