/**
 * OpenAIAdapterPromptCompressionLZGateway.js - LLM Gateway & Semantic Optimization: OpenAIAdapter -> PromptCompressionLZ.
 */

class OpenAIAdapterPromptCompressionLZGateway {
  constructor(config = {}) {
...
module.exports = { OpenAIAdapterPromptCompressionLZGateway };
