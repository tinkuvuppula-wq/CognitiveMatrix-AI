/**
 * OpenAIAdapterFallbackFailoverRouterGateway.js - LLM Gateway & Semantic Optimization: OpenAIAdapter -> FallbackFailoverRouter.
 */

class OpenAIAdapterFallbackFailoverRouterGateway {
  constructor(config = {}) {
...
module.exports = { OpenAIAdapterFallbackFailoverRouterGateway };
