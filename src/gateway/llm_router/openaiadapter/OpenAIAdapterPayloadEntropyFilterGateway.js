/**
 * OpenAIAdapterPayloadEntropyFilterGateway.js - LLM Gateway & Semantic Optimization: OpenAIAdapter -> PayloadEntropyFilter.
 */

class OpenAIAdapterPayloadEntropyFilterGateway {
  constructor(config = {}) {
...
module.exports = { OpenAIAdapterPayloadEntropyFilterGateway };
