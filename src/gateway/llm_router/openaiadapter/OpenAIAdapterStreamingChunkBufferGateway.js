/**
 * OpenAIAdapterStreamingChunkBufferGateway.js - LLM Gateway & Semantic Optimization: OpenAIAdapter -> StreamingChunkBuffer.
 */

class OpenAIAdapterStreamingChunkBufferGateway {
  constructor(config = {}) {
...
module.exports = { OpenAIAdapterStreamingChunkBufferGateway };
