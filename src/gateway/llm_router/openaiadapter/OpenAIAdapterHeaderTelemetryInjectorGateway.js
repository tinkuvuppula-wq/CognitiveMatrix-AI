/**
 * OpenAIAdapterHeaderTelemetryInjectorGateway.js - LLM Gateway & Semantic Optimization: OpenAIAdapter -> HeaderTelemetryInjector.
 */

class OpenAIAdapterHeaderTelemetryInjectorGateway {
  constructor(config = {}) {
...
module.exports = { OpenAIAdapterHeaderTelemetryInjectorGateway };
