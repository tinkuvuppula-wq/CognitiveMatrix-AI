/**
 * vLLMInferenceEnginePIIMaskingSanitizerGateway.js - LLM Gateway & Semantic Optimization: vLLMInferenceEngine -> PIIMaskingSanitizer.
 */

class vLLMInferenceEnginePIIMaskingSanitizerGateway {
  constructor(config = {}) {
    this.adapter = 'vLLMInferenceEngine';
    this.optimizer = 'PIIMaskingSanitizer';
...
module.exports = { vLLMInferenceEnginePIIMaskingSanitizerGateway };
