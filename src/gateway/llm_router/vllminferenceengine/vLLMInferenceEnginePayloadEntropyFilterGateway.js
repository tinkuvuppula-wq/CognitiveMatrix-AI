/**
 * vLLMInferenceEnginePayloadEntropyFilterGateway.js - LLM Gateway & Semantic Optimization: vLLMInferenceEngine -> PayloadEntropyFilter.
 */

class vLLMInferenceEnginePayloadEntropyFilterGateway {
  constructor(config = {}) {
    this.adapter = 'vLLMInferenceEngine';
    this.optimizer = 'PayloadEntropyFilter';
...
module.exports = { vLLMInferenceEnginePayloadEntropyFilterGateway };
