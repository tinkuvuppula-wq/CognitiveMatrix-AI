/**
 * DeepSeekAdapterAuditLogShipperGateway.js - LLM Gateway & Semantic Optimization: DeepSeekAdapter -> AuditLogShipper.
 */

class DeepSeekAdapterAuditLogShipperGateway {
  constructor(config = {}) {
...
module.exports = { DeepSeekAdapterAuditLogShipperGateway };
