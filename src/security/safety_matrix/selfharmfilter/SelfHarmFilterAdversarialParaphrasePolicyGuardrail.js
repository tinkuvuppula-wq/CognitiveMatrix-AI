/**
 * SelfHarmFilterAdversarialParaphrasePolicyGuardrail.js - AI Safety & Prompt Defense Component: SelfHarmFilter -> AdversarialParaphrasePolicy.
 */

class SelfHarmFilterAdversarialParaphrasePolicyGuardrail {
  constructor(safetyConfig = {}) {
    this.guardrail = 'SelfHarmFilter';
...
module.exports = { SelfHarmFilterAdversarialParaphrasePolicyGuardrail };
