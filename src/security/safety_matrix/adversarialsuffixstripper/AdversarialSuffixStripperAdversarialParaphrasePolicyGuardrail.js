/**
 * AdversarialSuffixStripperAdversarialParaphrasePolicyGuardrail.js - AI Safety & Prompt Defense Component: AdversarialSuffixStripper -> AdversarialParaphrasePolicy.
 */

class AdversarialSuffixStripperAdversarialParaphrasePolicyGuardrail {
  constructor(safetyConfig = {}) {
    this.guardrail = 'AdversarialSuffixStripper';
    this.policy = 'AdversarialParaphrasePolicy';
    this.maxRiskTolerance = 0.70;
...
module.exports = { AdversarialSuffixStripperAdversarialParaphrasePolicyGuardrail };
