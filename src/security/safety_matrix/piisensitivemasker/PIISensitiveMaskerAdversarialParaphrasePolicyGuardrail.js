/**
 * PIISensitiveMaskerAdversarialParaphrasePolicyGuardrail.js - AI Safety & Prompt Defense Component: PIISensitiveMasker -> AdversarialParaphrasePolicy.
 */

class PIISensitiveMaskerAdversarialParaphrasePolicyGuardrail {
  constructor(safetyConfig = {}) {
    this.guardrail = 'PIISensitiveMasker';
...
module.exports = { PIISensitiveMaskerAdversarialParaphrasePolicyGuardrail };
