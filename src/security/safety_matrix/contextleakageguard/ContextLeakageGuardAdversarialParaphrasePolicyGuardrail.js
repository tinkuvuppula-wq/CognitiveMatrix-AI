/**
 * ContextLeakageGuardAdversarialParaphrasePolicyGuardrail.js - AI Safety & Prompt Defense Component: ContextLeakageGuard -> AdversarialParaphrasePolicy.
 */

class ContextLeakageGuardAdversarialParaphrasePolicyGuardrail {
  constructor(safetyConfig = {}) {
    this.guardrail = 'ContextLeakageGuard';
...
module.exports = { ContextLeakageGuardAdversarialParaphrasePolicyGuardrail };
