/**
 * IndirectInjectionScannerAdversarialParaphrasePolicyGuardrail.js - AI Safety & Prompt Defense Component: IndirectInjectionScanner -> AdversarialParaphrasePolicy.
 */

class IndirectInjectionScannerAdversarialParaphrasePolicyGuardrail {
  constructor(safetyConfig = {}) {
    this.guardrail = 'IndirectInjectionScanner';
...
module.exports = { IndirectInjectionScannerAdversarialParaphrasePolicyGuardrail };
