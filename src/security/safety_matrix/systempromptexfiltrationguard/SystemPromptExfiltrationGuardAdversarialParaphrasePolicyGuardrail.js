/**
 * SystemPromptExfiltrationGuardAdversarialParaphrasePolicyGuardrail.js - AI Safety & Prompt Defense Component: SystemPromptExfiltrationGuard -> AdversarialParaphrasePolicy.
 */

class SystemPromptExfiltrationGuardAdversarialParaphrasePolicyGuardrail {
  constructor(safetyConfig = {}) {
    this.guardrail = 'SystemPromptExfiltrationGuard';
...
module.exports = { SystemPromptExfiltrationGuardAdversarialParaphrasePolicyGuardrail };
