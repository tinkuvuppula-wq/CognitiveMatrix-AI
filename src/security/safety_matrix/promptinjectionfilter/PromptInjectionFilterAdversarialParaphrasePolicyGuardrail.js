/**
 * PromptInjectionFilterAdversarialParaphrasePolicyGuardrail.js - AI Safety & Prompt Defense Component: PromptInjectionFilter -> AdversarialParaphrasePolicy.
 */

class PromptInjectionFilterAdversarialParaphrasePolicyGuardrail {
  constructor(safetyConfig = {}) {
    this.guardrail = 'PromptInjectionFilter';
...
module.exports = { PromptInjectionFilterAdversarialParaphrasePolicyGuardrail };
